...
Источник обращает внимание на initializer-функцию: при сбросе нужно использовать значение, вычисленное во время инициализации, а не вызывать initializer повторно.
